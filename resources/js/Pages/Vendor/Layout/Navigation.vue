...
const isVendorsLinks = () => {
    ...
    if (component === 'Ceedo/Dashboard/Vendors/AllVendors' || component === 'Ceedo/Dashboard/Vendors/Application' || component === 'Ceedo/Dashboard/Vendors/Compliance') {
...
const isHistoryLinks = () => {
    if (component == 'Ceedo/Dashboard/History/Activities' || component == 'Ceedo/Dashboard/History/Notifications') {
    ...
    <ul class="mt-6">
        <li class="relative px-6 py-3">
            <span class="absolute inset-y-0 left-0 w-1  rounded-tr-lg rounded-br-lg"
                :class="{ 'bg-orange-600': $page.component.startsWith('Vendor/Page/Dashboard') }"
            ...
            <Link
                ...
                :class="{ 'text-gray-800 disabled:opacity-50 pointer-events-none': $page.component.startsWith('Vendor/Page/Dashboard') }"
