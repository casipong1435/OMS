...
<template>
  ...
  <Dashboard>
    ...
    <div class="breadcrumbs text-sm">
      <ul>
        <li>
          <a @click="goBack()">Business Payment List</a>
        </li>
        <li>My Business Payments</li>
      </ul>
    </div>
    ...
    <div v-if="business">
          ...
          <div class="container mx-auto-grid">
            ...
            <div class="mb-6 p-4 bg-blue-100 rounded shadow">
              ...
              <p class="text-gray-700">
                ...
                <span>Penalty: </span> {{ '₱' + nextPayment.penalty.toFixed(2) }} <br>
              ...
              <table class="min-w-full bg-white border rounded">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="px-4 py-2"> {{ '₱' + nextPayment.penalty.toFixed(2) }}</td>
                  ...
                  <tr v-for="payment in overduePayments" :key="payment.due_date">
                    ...
                    <td class="px-4 py-2"> {{ '₱' + payment.penalty.toFixed(2) }}</td>
      ...
      <div v-if="business.status == 0" class="flex flex-col justify-center items-center mt-20 md:mt-0"
        ...
        <span class="text-2xl mb-3 text-justify">Your applicaction is currently under review. You will receive an SMS
          from CEEDO once your application is approved or rejected!</span>
      </div>
    </div>
